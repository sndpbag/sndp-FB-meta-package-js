// ============================================
// NODE.JS JAVASCRIPT - src/index.js
// ============================================
const express = require('express');
const dotenv = require('dotenv');
const session = require('express-session');
const { createExpressAuthMiddleware } = require('@sndp/meta-auth-server/middleware');
const { createExpressWebhook } = require('@sndp/meta-whatsapp');
